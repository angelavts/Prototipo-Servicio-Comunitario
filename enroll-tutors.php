                    ...
                    <div class="container py-5">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Inscribir un tutor</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                <div class="col-sm-3">
                                ...
                                <a href="" class="btn btn-primary btn-icon-split">
                                    ...
                                    <span class="text">Inscribir tutor</span>
                                </a>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Inscribir tutores a partir de un archivo</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                ...
                                <a href="" class="btn btn-primary btn-icon-split">
                                    ...
                                    <span class="text">Inscribir tutores</span>
                                </a>
                                </div>
