                    ...
                    <div class="container py-5">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Inscribir un estudiante</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">Proyecto</p>
                                    </div>
                                    <div class="col-sm-9">
                                        <select class="form-control">
                                            <option>Seleccionar</option>
                                            <option>Creación de sistema de gestión</option>
                                            <option>Automatización de proceso</option>
                                        </select>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <a href="" class="btn btn-primary btn-icon-split">
                                    ...
                                    <span class="text">Inscribir estudiante</span>
                                </a>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Inscribir estudiantes a partir de un archivo</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
